...
UwpDx11XamlAppMain::UwpDx11XamlAppMain(const std::shared_ptr<DX::DeviceResources>& deviceResources) :
...
UwpDx11XamlAppMain::~UwpDx11XamlAppMain()
{
	// デバイスの通知を登録解除しています
...
void UwpDx11XamlAppMain::CreateWindowSizeDependentResources() 
{
	// TODO: これをアプリのコンテンツのサイズに依存する初期化で置き換えます。
	m_sceneRenderer->CreateWindowSizeDependentResources();
}

void UwpDx11XamlAppMain::StartRenderLoop()
{
...
void UwpDx11XamlAppMain::StopRenderLoop()
{
	m_renderLoopWorker->Cancel();
}

// アプリケーション状態をフレームごとに 1 回更新します。
void UwpDx11XamlAppMain::Update() 
{
	ProcessInput();
...
void UwpDx11XamlAppMain::ProcessInput()
{
...
bool UwpDx11XamlAppMain::Render() 
{
...
void UwpDx11XamlAppMain::OnDeviceLost()
{
...
void UwpDx11XamlAppMain::OnDeviceRestored()
{
