...
void ::UwpDx11XamlApp::DirectXPage::InitializeComponent()
{
    if (_contentLoaded)
    {
        return;
...
void ::UwpDx11XamlApp::DirectXPage::Connect(int __connectionId, ::Platform::Object^ __target)
{
        ...
        case 3:
            {
                ...
                (safe_cast<::Windows::UI::Xaml::Controls::AppBarButton^>(element3))->Click += ref new ::Windows::UI::Xaml::RoutedEventHandler(this, (void (::UwpDx11XamlApp::DirectXPage::*)
...
::Windows::UI::Xaml::Markup::IComponentConnector^ ::UwpDx11XamlApp::DirectXPage::GetBindingConnector(int __connectionId, ::Platform::Object^ __target)
{
